...
import com.johnakins.product.exception.ProductPurchaseException;
import com.johnakins.product.inventory.InventoryClient;
...
public class ProductService {
    ...
    public List<ProductPurchaseResponse> purchaseProducts(
        ...
        for (int i = 0; i < storedProducts.size(); i++) {
            ...
            // 👉 Delegate stock handling to Inventory Service
            try {
